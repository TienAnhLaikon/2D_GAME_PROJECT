...
bool SettingsManager::init()
{
    ...
    // Nu cha tn ti SettingsManager trong scene, th thm mi
    menu = Sprite::create("res/c_full_header.png");
    ...
    // t v tr cho button
    closeButton->setPosition(Vec2(menu->getContentSize().width - 60, menu->getContentSize().height - 60));
    ...
    settingsTitle->setPosition(Vec2(menu->getContentSize().width / 2, menu->getContentSize().height - 50));
    settingsTitle->enableBold();
    menu->addChild(settingsTitle);
    ...
    gearPinionLeft->setPosition(Vec2(menu->getContentSize().width / 2 - 300, menu->getContentSize().height - 50));
    gearPinionRight->setPosition(Vec2(menu->getContentSize().width / 2 + 300, menu->getContentSize().height - 50));
    menu->addChild(gearPinionLeft);
    menu->addChild(gearPinionRight);




    auto header1 = Sprite::create("res/header_BROWN.png");
    header1->setPosition(Vec2(header1->getContentSize().width / 2 + 10 * Director::getInstance()->getContentScaleFactor(), menu->getContentSize().height * (0.3 * Director::getInstance()->getContentScaleFactor()) + 150));
    menu->addChild(header1);

    auto bigSoundTitle = Label::createWithTTF("SOUND", "fonts/Diablo Light.ttf", 55);
    bigSoundTitle->setPosition(header1->getContentSize().width / 2 + 20 * Director::getInstance()->getContentScaleFactor(), menu->getContentSize().height * (0.3 * Director::getInstance()->getContentScaleFactor()) + 150);
    menu->addChild(bigSoundTitle);

    auto musicIcon = Sprite::create("res/music_icon.png");
    musicIcon->setPosition(header1->getContentSize().width / 2 - bigSoundTitle->getContentSize().width / 2 - (10 * Director::getInstance()->getContentScaleFactor()), menu->getContentSize().height * (0.3 * Director::getInstance()->getContentScaleFactor()) + 150);
    menu->addChild(musicIcon);

            
    // settings Music
    musicTitle = Label::createWithTTF("Music", "fonts/Diablo Light.ttf", 55);
    musicTitle->setPosition(header1->getPosition() - Vec2(musicTitle->getContentSize().width / 2 - 100, musicTitle->getContentSize().height * 2));
    menu->addChild(musicTitle);
    ...
    sprite->setScaleX(menu->getContentSize().width * (0.3 * Director::getInstance()->getContentScaleFactor()) / sprite->getContentSize().width * 1.3);
    ...
    musicSlider->setScale(menu->getContentSize().width * (0.3 * Director::getInstance()->getContentScaleFactor()) / sprite->getContentSize().width * 1.3);
    ...
    menu->addChild(musicSlider,5);
    menu->addChild(sprite, 4);
    ...
    // settings Sound
    soundTitle = Label::createWithTTF("Sound", "fonts/Diablo Light.ttf", 55);
    ...
    sprite2->setScaleX(menu->getContentSize().width* (0.3 * Director::getInstance()->getContentScaleFactor()) / sprite2->getContentSize().width * 1.3);
    ...
    soundSlider->setScale(menu->getContentSize().width* (0.3 * Director::getInstance()->getContentScaleFactor()) / sprite2->getContentSize().width * 1.3);
    ...
    menu->addChild(soundSlider, 5);
    menu->addChild(sprite2, 4);
    ...
    touchListener->onTouchBegan = CC_CALLBACK_2(SettingsManager::onTouchBegan, this);
    touchListener->onTouchMoved = CC_CALLBACK_2(SettingsManager::onTouchMoved, this);
    touchListener->onTouchEnded = CC_CALLBACK_2(SettingsManager::onTouchEnded, this);
    _eventDispatcher->addEventListenerWithSceneGraphPriority(touchListener, this);

    return true;
}

bool SettingsManager::isMenuShow()
{

	return this->isVisible();
}

void SettingsManager::showMenuList()
{
...
void SettingsManager::hideMenuList()
{
    this->setVisible(false);
    // Lấy đối tượng cha
    auto parent = dynamic_cast<MainMenuScene*>(this->getParent());
    if (parent) {
        // Set các nút visible
        parent->playButton->setVisible(true);
        parent->tutorialButton->setVisible(true);
        parent->settingsButton->setVisible(true);
        parent->exitButton->setVisible(true);
        parent->playLabel->setVisible(true);
        parent->tutorialLabel->setVisible(true);
        parent->settingsLabel->setVisible(true);
        parent->exitLabel->setVisible(true);
    }
}



bool SettingsManager::onTouchBegan(Touch* touch, Event* event)
{
    if (isVisible()) {
...
void SettingsManager::onTouchMoved(Touch* touch, Event* event)
{
}

void SettingsManager::onTouchEnded(Touch* touch, Event* event)
{
}
