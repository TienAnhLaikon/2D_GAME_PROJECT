#include "./ChippedArmor.h"

bool ChippedArmor::init()
{
    ...
    this->setTexture("sprites/equipment/a_armor_white.png");
    this->setArmor(20);
    this->setEquipmentName("Chipped Armor");
    this->setTypeName("Armor");
    this->setEquipmentType(BaseEquipment::Type::STANDARD);
    this->setEquipmentDesc("An old and worn armor with\n several dents and scratches. \nIt offers basic protection \nbut is far from ideal for \nintense combat situations");
