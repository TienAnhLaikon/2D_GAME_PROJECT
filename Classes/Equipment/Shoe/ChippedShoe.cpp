#include "./ChippedShoe.h"

bool ChippedShoe::init()
{
    ...
    this->setTexture("sprites/equipment/a_shoe_white.png");
    this->setMovementSpeed(15);
    this->setEquipmentName("Chipped Shoe");
    this->setTypeName("Shoe");
    this->setEquipmentType(BaseEquipment::Type::STANDARD);
    this->setEquipmentDesc("Basic shoes with noticeable signs\nof wear. They offer minimal\nprotectionand support, suitable\nfor lighttravel but not for battle");
